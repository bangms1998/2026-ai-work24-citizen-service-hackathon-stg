...
- 외부: `https://bangms1998.github.io/work24-googleform-landing-stg/`
- HTTPS: enforced
...
2026-08-26 외부 검증: Pages build `built`, 홈·guide·FAQ·inquiry·CSS·site-config HTTP 200, 공개 브라우저 accessibility tree 확인 PASS.
